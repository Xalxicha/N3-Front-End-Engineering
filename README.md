* Portfólio Acadêmico - Atividade Avaliativa N3

Este projeto é uma Landing Page de apresentação pessoal desenvolvida como parte dos requisitos para a obtenção de nota na disciplina de Frontend Design Engineering no curso de Análise e Desenvolvimento de Sistemas da FASIPE JET.
...
* Botões Sociais: Links configurados para direcionamento direto às redes do desenvolvedor (GitHub e Instagram);
* Integração com a BrasilAPI: Consumo nativo via fetch de 3 rotas públicas da [BrasilAPI](https://brasilapi.com.br/):
    * Consulta de CEP: Informa rua, bairro, cidade e estado;
    * Consulta de DDD: Retorna o estado correspondente e a quantidade de cidades registradas;
...
* Disciplina: Frontend Design Engineering

OBS: Este site/repositório têm fins puramente acadêmicos.
